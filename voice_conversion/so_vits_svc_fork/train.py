...
def train(
    config_path: Path | str, model_path: Path | str, reset_optimizer: bool = False, max_epochs: int = None,
):
    ...
    trainer = pl.Trainer(
        ...
        max_epochs=hparams.train.epochs if max_epochs == None else max_epochs,
