...
#     default=None,
#     type=int,
#     help="max number of train epochs",
# )
def train(
    config_path: Path,
    model_path: Path,
    ...
    train(
        config_path=config_path, model_path=model_path, reset_optimizer=reset_optimizer, max_epochs=max_epochs
    )
...
def pre_config(
    ...
    filelist_path: Path,
    config_path: Path,
    config_type: str = "so-vits-svc-4.0v1",
):
